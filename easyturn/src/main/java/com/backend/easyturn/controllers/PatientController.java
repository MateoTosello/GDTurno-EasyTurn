...
public class PatientController {
    ...
    @ResponseBody
    public ResponseEntity<PatientDTO> getPatientById(@PathVariable int idPatient){
        Patient patient = this.patientService.getPatientById(idPatient);
        return  new ResponseEntity<>(patient.toDTO(), HttpStatus.OK);
    }

    @GetMapping("/get-professional")
    @ResponseBody
    public ResponseEntity<List<PatientDTO>> getProfessional(){
